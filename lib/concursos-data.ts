...
export const concursosData: MaterialConcurso[] = [
  ...
  // ========== ESTADUAL - EXPANSÃO ==========
  {
    ...
    categoria: "estadual",
    materia: "Português",
    titulo: "Concordância Verbal para PM/Bombeiros",
    tipo: "videoaula",
    descricao: "Casos especiais de concordância cobrados em concursos.",
    videoId: "iX5M5xqQIAE",
    duracao: 16,
  },
  {
    ...
    categoria: "estadual",
    materia: "Português",
    titulo: "Regência Verbal - Questões de Prova",
    tipo: "videoaula",
    descricao: "Verbos que mais caem em concursos estaduais.",
    videoId: "tKL6x5LZSBU",
    duracao: 15,
  },
  {
    ...
    categoria: "estadual",
    materia: "Matemática",
    titulo: "Porcentagem Aplicada",
    tipo: "videoaula",
    descricao: "Cálculos de porcentagem em situações práticas.",
    videoId: "Fq2oBVp9_1E",
    duracao: 17,
  },
  {
    ...
    categoria: "estadual",
    materia: "Matemática",
    titulo: "Geometria Plana - Questões PM",
    tipo: "videoaula",
    descricao: "Área, perímetro e volume para concursos.",
    videoId: "N8dGWpj3dQc",
    duracao: 18,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Proposições, conectivos e tabela verdade.",
    videoId: "wYbIm-v4LBg",
    duracao: 20,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Sistema operacional mais cobrado.",
    videoId: "8cqLhb5ywGU",
    duracao: 16,
  },
  {
    ...
    categoria: "estadual",
    materia: "Informática",
    titulo: "Microsoft Office - Excel",
    tipo: "videoaula",
    descricao: "Fórmulas e funções essenciais.",
    videoId: "yHVELjI5dLI",
    duracao: 19,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Navegadores, e-mail, vírus e proteção.",
    videoId: "3b_yWSBSTYw",
    duracao: 17,
  },
  ...
  // ========== TRIBUNAIS - EXPANSÃO ==========
  {
    ...
    categoria: "tribunais",
    materia: "Português",
    titulo: "Interpretação de Textos Jurídicos",
    tipo: "videoaula",
    descricao: "Como interpretar textos complexos em provas de TJ/TRT.",
    videoId: "Nn9jBLu5fzM",
    duracao: 18,
  },
  {
    ...
    categoria: "tribunais",
    materia: "Português",
    titulo: "Pontuação para Tribunais",
    tipo: "videoaula",
    descricao: "Vírgula, ponto e vírgula em questões de prova.",
    videoId: "7XBmLZ4FHAE",
    duracao: 16,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Diagramas lógicos e equivalências.",
    videoId: "aVJmU6Uiq3Y",
    duracao: 19,
  },
  {
    ...
    titulo: "Análise Combinatória",
    tipo: "videoaula",
    descricao: "Permutação, arranjo e combinação.",
    videoId: "TyF8m3wB1sU",
    duracao: 20,
  },
  {
    ...
    titulo: "Atos Administrativos",
    tipo: "videoaula",
    descricao: "Conceito, classificação e atributos.",
    videoId: "gzxR5NPEJ2s",
    duracao: 22,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Teoria objetiva e excludentes.",
    videoId: "2NRbqBGa8Jw",
    duracao: 18,
  },
  {
    ...
    titulo: "Organização do Estado",
    tipo: "videoaula",
    descricao: "União, Estados, DF e Municípios.",
    videoId: "Lp0jFcVLnUQ",
    duracao: 19,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Organização e competências dos tribunais.",
    videoId: "4hZ4JMZ8dqw",
    duracao: 21,
  },
  ...
  // ========== ENEM - EXPANSÃO ==========
  {
    ...
    categoria: "enem",
    materia: "Redação",
    titulo: "Proposta de Intervenção Nota 1000",
    tipo: "videoaula",
    descricao: "Como fazer uma proposta completa e detalhada.",
    videoId: "yjZ8bxVRhpY",
    duracao: 16,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Como usar citações, dados e referências.",
    videoId: "w9KLvpBz2Dw",
    duracao: 15,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "DNA, clonagem, transgênicos.",
    videoId: "39wy9PFUx0k",
    duracao: 19,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Pilhas, baterias e eletrólise.",
    videoId: "J4BEqPSvj-Q",
    duracao: 18,
  },
  {
    ...
    titulo: "Ondas e Som",
    tipo: "videoaula",
    descricao: "Propriedades ondulatórias.",
    videoId: "9jZNCxKF8sw",
    duracao: 17,
  },
  {
    ...
    categoria: "enem",
    materia: "Ciências Humanas",
    titulo: "Movimentos Sociais no Brasil",
    tipo: "videoaula",
    descricao: "MST, movimentos negros, feministas.",
    videoId: "dW7qJzP8xUY",
    duracao: 18,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Mercado global, blocos econômicos.",
    videoId: "0LGYKwdCjGM",
    duracao: 16,
  },
  {
    ...
    titulo: "Funções da Linguagem",
    tipo: "videoaula",
    descricao: "Referencial, emotiva, conativa, fática, metalinguística, poética.",
    videoId: "pkYqBhVmvHE",
    duracao: 14,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Tendências literárias atuais.",
    videoId: "v8LhKMEfHfE",
    duracao: 15,
  },
  ...
  // ========== FEDERAL - EXPANSÃO ==========
  {
    ...
    titulo: "Redes de Computadores",
    tipo: "videoaula",
    descricao: "Topologias, protocolos TCP/IP.",
    videoId: "S8w0s6vuHCg",
    duracao: 20,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Comandos básicos e estrutura.",
    videoId: "SXRbZQbMGdQ",
    duracao: 18,
  },
  {
    ...
    tipo: "videoaula",
    descricao: "Licitação, contratos e convênios.",
    videoId: "8o7pYN_6qJw",
    duracao: 21,
  },
];
